...
export class Deportista {
  ...
  @OneToMany(() => Contacto, (contacto) => contacto.deportista, { onDelete: 'CASCADE' })
  contactos: Contacto[];

  @OneToMany(() => Transferencia, (transferencia) => transferencia.deportista, { onDelete: 'CASCADE' })
  transferencias: Transferencia[];

  @OneToMany(() => EstadisticaPartido, (estadistica) => estadistica.deportista, { onDelete: 'CASCADE' })
  estadisticas: EstadisticaPartido[];

  @OneToMany(() => ClubDeportista, (clubDeportista) => clubDeportista.deportista, { onDelete: 'CASCADE' })
